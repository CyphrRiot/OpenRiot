...
> _"We built Monero from source, broke the build, rebuilt it, patched linker scripts, installed Qt5 QML modules, realized the build was too brittle to ship, and finally just tarball'd the binaries like civilized people. The four-hour compile taught us humility. The tarball taught us wisdom. Your wallet is now one `Super+Space` away. Your lock screen looks like it knows what a view key is. And if you haven't configured crypto prices, the polybar icon has the good grace to not stare at you in judgment."_
